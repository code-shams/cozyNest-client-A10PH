        ...
        <div className="py-5 w-11/12 max-w-[1550px] mx-auto">
            ...
            >
                    ...
                    <div className="space-y-3 mt-3">
                        ...
                        <div className="flex justify-center space-x-4">
                            <button
                                ...
                                className="block w-full sm:py-2 focus:ring-2 focus:ring-offset-1 cursor-pointer p-1 sm:p-3 text-center relative px-5 py-2 overflow-hidden font-medium text-gray-600 bg-gray-100 border border-slate-300 rounded-lg shadow-inner group"
                            >
                                <span className="absolute top-0 left-0 w-0 h-0 transition-all duration-200 border-t-2 border-gray-600 group-hover:w-full ease"></span>
                                <span className="absolute bottom-0 right-0 w-0 h-0 transition-all duration-200 border-b-2 border-gray-600 group-hover:w-full ease"></span>
                                <span className="absolute top-0 left-0 w-full h-0 transition-all duration-300 delay-200 bg-gray-600 group-hover:h-full ease"></span>
                ...
                <div className="my-auto md:w-3/5">
                    <h1 className="text-center text-xl md:text-2xl lg:text-3xl font-extrabold pri-font">
                        Welcome Back to CozyNest
                    </h1>
                    <Lottie className="h-full" animationData={ani2}></Lottie>
                </div>
            </div>
        </div>
    );
