...
const AddRoom = () => {
    ...
    const handleAddPost = (e) => {
        ...
        formObj.likeCount = 0;
        formObj.availability = "Available";
        console.log(formObj);
    };
    return (
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 mb-2 md:mb-6">
                            <input
                                type="text"
                                name="name"
                                className="mt-1 block w-full sm:w-1/2 rounded-md border border-slate-300 bg-gray-50 px-3 py-4 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-black focus:outline-none focus:ring-1 focus:ring-black sm:text-sm"
                                disabled
                        ...
                        <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
                            <input
                                type="text"
                                name="title"
                                className="mt-1 block w-full sm:w-1/2 rounded-md border border-slate-300 bg-white px-3 py-4 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-black focus:outline-none focus:ring-1 focus:ring-black sm:text-sm"
                                placeholder="Title"
                            />
                            <input
                                type="text"
                        ...
                        <div className="my-2 sm:my-6">
                            <input
                                type="text"
                                name="photo"
                                className="mt-1 block w-full rounded-md border border-slate-300 bg-white px-3 py-4 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-black focus:outline-none focus:ring-1 focus:ring-black sm:text-sm"
